...
{
	public class MySkool_MyLinearLayoutManager : LinearLayoutManager {


		public MySkool_MyLinearLayoutManager(Context context) : base (context)
		{
			
		}
		public MySkool_MyLinearLayoutManager(Context context, int orientation, bool reverseLayout) : base(context, orientation, reverseLayout)
		{
