...
{
	public class MySkool_SlidingTabScrollView : HorizontalScrollView
	{
		...
		private static MySkool_SlidingTabStrip mTabStrip;
		...
		public MySkool_SlidingTabScrollView(Context context) : this(context, null) { }

		public MySkool_SlidingTabScrollView(Context context, IAttributeSet attrs) : this(context, attrs, 0) { }

		public MySkool_SlidingTabScrollView (Context context, IAttributeSet attrs, int defaultStyle) : base(context, attrs, defaultStyle)
		{
			...
			mTabStrip = new MySkool_SlidingTabStrip(context);
		...
		private void PopulateTabStrip()
		{
			...
			for (int i = 0; i < adapter.Count; i++)
			{
				...
				tabView.Text = ((MySkool_ViewPagerAdapter)adapter).GetHeaderTitle(i);
