...
{
	public class MyShop_SlidingTabScrollView : HorizontalScrollView
	{
		...
		private static MyShop_SlidingTabStrip mTabStrip;
		...
		public MyShop_SlidingTabScrollView(Context context) : this(context, null) { }

		public MyShop_SlidingTabScrollView(Context context, IAttributeSet attrs) : this(context, attrs, 0) { }

		public MyShop_SlidingTabScrollView (Context context, IAttributeSet attrs, int defaultStyle) : base(context, attrs, defaultStyle)
		{
			...
			FillViewport = true;
			//this.SetBackgroundColor(Android.Graphics.Color.Rgb(248,159,21)); //Gray color 248	159	21 0xE5, 0xE5, 0xE5
			this.SetBackgroundColor(Android.Graphics.Color.ParseColor("#9C27B0")); 

			mTitleOffset = (int)(TITLE_OFFSET_DIPS * Resources.DisplayMetrics.Density);

			mTabStrip = new MyShop_SlidingTabStrip(context);
		...
		private void PopulateTabStrip()
		{
			...
			for (int i = 0; i < adapter.Count; i++)
			{
				...
				tabView.Text = ((MyShop_ViewPagerAdapter)adapter).GetHeaderTitle(i);
