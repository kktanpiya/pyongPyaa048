...
{
	public class MyShop_SlidingTabStrip : LinearLayout
	{
		...
		private int[] INDICATOR_COLORS = { 0x3e0f46, 0x3e0f46 };
		...
		//Tab colorizer
		private MyShop_SlidingTabScrollView.TabColorizer mCustomTabColorizer;
		private SimpleTabColorizer mDefaultTabColorizer;
		//Stop copy and paste here........................................................................

		//Constructors
		public MyShop_SlidingTabStrip (Context context) : this(context, null)
		{ }

		public MyShop_SlidingTabStrip (Context context, IAttributeSet attrs) : base(context, attrs)
		{
			...
			mBottomBorderPaint.Color = GetColorFromInteger(0x4e1358 ); //Gray 0xC5C5C5 #4e1358
		...
		public MyShop_SlidingTabScrollView.TabColorizer CustomTabColorizer
		{
			set
			{
		...
		protected override void OnDraw(Canvas canvas)
		{
			...
			MyShop_SlidingTabScrollView.TabColorizer tabColorizer = mCustomTabColorizer != null ? mCustomTabColorizer : mDefaultTabColorizer;
		...
		private class SimpleTabColorizer : MyShop_SlidingTabScrollView.TabColorizer
		{
