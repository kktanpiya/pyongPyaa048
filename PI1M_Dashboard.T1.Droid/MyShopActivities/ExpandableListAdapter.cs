...
namespace PI1M_Dashboard.T1.Droid
{
	...
	public class MyShop_ExpandableListAdapter : BaseExpandableListAdapter
	{
		public Activity context;
		public List<string> month = new List<string>();
		public List<MyShop_Child_Data> mData;
		public ChildViewHolder cHolder;
		public HeaderViewHolder hHolder;
		//private List<HeaderInfo> mHeader;

		public MyShop_ExpandableListAdapter(Activity context, List<string> month, List<MyShop_Child_Data> data)
		{
		...
		public override int GetChildrenCount (int groupPosition)
		{
			...
			List<MyShop_Child_Data> result = mData.FindAll (((MyShop_Child_Data obj) => obj.mMonth.Equals (header)));
			return result.Count;
		...
		public override View GetChildView (int groupPosition, int childPosition, bool isLastChild, View convertView, ViewGroup parent)
		{
			...
			if (convertView == null) {
				convertView = context.LayoutInflater.Inflate (Resource.Layout.MyShop_list_item, null);
		...
		public override View GetGroupView (int groupPosition, bool isExpanded, View convertView, ViewGroup parent)
		{
			...
			if (convertView == null) {
				convertView = context.LayoutInflater.Inflate (Resource.Layout.MyShop_list_group, null);
