...
{
	public class MyHealth_MyLinearLayoutManager : LinearLayoutManager {


		public MyHealth_MyLinearLayoutManager(Context context) : base (context)
		{
			
		}
		public MyHealth_MyLinearLayoutManager(Context context, int orientation, bool reverseLayout) : base(context, orientation, reverseLayout)
		{
