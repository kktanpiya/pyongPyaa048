...
{
	public class MyHealth_SlidingTabScrollView : HorizontalScrollView
	{
		...
		private static MyHealth_SlidingTabStrip mTabStrip;
		...
		public MyHealth_SlidingTabScrollView(Context context) : this(context, null) { }

		public MyHealth_SlidingTabScrollView(Context context, IAttributeSet attrs) : this(context, attrs, 0) { }

		public MyHealth_SlidingTabScrollView (Context context, IAttributeSet attrs, int defaultStyle) : base(context, attrs, defaultStyle)
		{
			...
			FillViewport = true;
			this.SetBackgroundColor(Android.Graphics.Color.ParseColor("#009688")); //Gray color 248	159	21 0xE5, 0xE5, 0xE5

			mTitleOffset = (int)(TITLE_OFFSET_DIPS * Resources.DisplayMetrics.Density);

			mTabStrip = new MyHealth_SlidingTabStrip(context);
		...
		private void PopulateTabStrip()
		{
			...
			for (int i = 0; i < adapter.Count; i++)
			{
				...
				tabView.Text = ((MyHealth_ViewPagerAdapter)adapter).GetHeaderTitle(i);
