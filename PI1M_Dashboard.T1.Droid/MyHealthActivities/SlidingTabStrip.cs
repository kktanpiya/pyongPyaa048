...
{
	public class MyHealth_SlidingTabStrip : LinearLayout
	{
		...
		//Tab colorizer
		private MyHealth_SlidingTabScrollView.TabColorizer mCustomTabColorizer;
		private SimpleTabColorizer mDefaultTabColorizer;
		//Stop copy and paste here........................................................................

		//Constructors
		public MyHealth_SlidingTabStrip (Context context) : this(context, null)
		{ }

		public MyHealth_SlidingTabStrip (Context context, IAttributeSet attrs) : base(context, attrs)
		{
		...
		public MyHealth_SlidingTabScrollView.TabColorizer CustomTabColorizer
		{
			set
			{
		...
		protected override void OnDraw(Canvas canvas)
		{
			...
			MyHealth_SlidingTabScrollView.TabColorizer tabColorizer = mCustomTabColorizer != null ? mCustomTabColorizer : mDefaultTabColorizer;
		...
		private class SimpleTabColorizer : MyHealth_SlidingTabScrollView.TabColorizer
		{
