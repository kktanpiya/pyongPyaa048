...
namespace PI1M_Dashboard.T1.Droid
{
	...
	public class MyHealth_ExpandableListAdapter : BaseExpandableListAdapter
	{
		public Activity context;
		public List<string> month = new List<string>();
		public List<MyHealth_Child_Data> mData;
		public ChildViewHolder cHolder;
		public HeaderViewHolder hHolder;
		//private List<HeaderInfo> mHeader;

		public MyHealth_ExpandableListAdapter(Activity context, List<string> month, List<MyHealth_Child_Data> data)
		{
		...
		public override int GetChildrenCount (int groupPosition)
		{
			...
			List<MyHealth_Child_Data> result = mData.FindAll (((MyHealth_Child_Data obj) => obj.mMonth.Equals (header)));
			return result.Count;
