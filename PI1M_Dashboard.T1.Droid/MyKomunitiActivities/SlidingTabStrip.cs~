...
{
	public class MyKomuniti_SlidingTabStrip : LinearLayout
	{
		//Copy and paste from here................................................................
		private const int DEFAULT_BOTTOM_BORDER_THICKNESS_DIPS = 0;//2
		private const byte DEFAULT_BOTTOM_BORDER_COLOR_ALPHA = 0X26;
		private const int SELECTED_INDICATOR_THICKNESS_DIPS = 8;
		//private int[] INDICATOR_COLORS = { 0xFF851F, 0xFFAD69 };
		private int[] INDICATOR_COLORS = { Color.ParseColor("#fc9a7c"), Color.ParseColor("#fdbba7") };
		...
		//Tab colorizer
		private MyKomuniti_SlidingTabScrollView.TabColorizer mCustomTabColorizer;
		private SimpleTabColorizer mDefaultTabColorizer;
		//Stop copy and paste here........................................................................

		//Constructors
		public MyKomuniti_SlidingTabStrip (Context context) : this(context, null)
		{ }

		public MyKomuniti_SlidingTabStrip (Context context, IAttributeSet attrs) : base(context, attrs)
		{
			...
			mBottomBorderPaint.Color = GetColorFromInteger(0xFF851F ); //Gray 0xC5C5C5
		...
		public MyKomuniti_SlidingTabScrollView.TabColorizer CustomTabColorizer
		{
			set
			{
		...
		protected override void OnDraw(Canvas canvas)
		{
			...
			MyKomuniti_SlidingTabScrollView.TabColorizer tabColorizer = mCustomTabColorizer != null ? mCustomTabColorizer : mDefaultTabColorizer;
		...
		private class SimpleTabColorizer : MyKomuniti_SlidingTabScrollView.TabColorizer
		{
