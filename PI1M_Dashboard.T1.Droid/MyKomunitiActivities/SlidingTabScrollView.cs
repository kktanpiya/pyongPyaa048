...
{
	public class MyKomuniti_SlidingTabScrollView : HorizontalScrollView
	{
		...
		private static MyKomuniti_SlidingTabStrip mTabStrip;
		...
		public MyKomuniti_SlidingTabScrollView(Context context) : this(context, null) { }

		public MyKomuniti_SlidingTabScrollView(Context context, IAttributeSet attrs) : this(context, attrs, 0) { }

		public MyKomuniti_SlidingTabScrollView (Context context, IAttributeSet attrs, int defaultStyle) : base(context, attrs, defaultStyle)
		{
			...
			FillViewport = true;
			this.SetBackgroundColor (Color.ParseColor ("#FA5725"));//Android.Graphics.Color.Rgb(248,159,21)); //Gray color 248	159	21 0xE5, 0xE5, 0xE5

			mTitleOffset = (int)(TITLE_OFFSET_DIPS * Resources.DisplayMetrics.Density);

			mTabStrip = new MyKomuniti_SlidingTabStrip(context);
		...
		private void PopulateTabStrip()
		{
			...
			for (int i = 0; i < adapter.Count; i++)
			{
				...
				tabView.Text = ((MyKomuniti_ViewPagerAdapter)adapter).GetHeaderTitle(i);
