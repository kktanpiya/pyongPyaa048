...
{
	public class MyKomuniti_MyLinearLayoutManager : LinearLayoutManager {


		public MyKomuniti_MyLinearLayoutManager(Context context) : base (context)
		{
			
		}
		public MyKomuniti_MyLinearLayoutManager(Context context, int orientation, bool reverseLayout) : base(context, orientation, reverseLayout)
		{
