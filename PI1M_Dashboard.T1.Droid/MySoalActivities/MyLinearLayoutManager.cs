...
{
	public class MySoal_MyLinearLayoutManager : LinearLayoutManager {


		public MySoal_MyLinearLayoutManager(Context context) : base (context)
		{
			
		}
		public MySoal_MyLinearLayoutManager(Context context, int orientation, bool reverseLayout) : base(context, orientation, reverseLayout)
		{
