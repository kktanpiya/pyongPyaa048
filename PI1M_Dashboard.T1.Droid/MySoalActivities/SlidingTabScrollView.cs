...
{
	public class MySoal_SlidingTabScrollView : HorizontalScrollView
	{
		...
		private static MySoal_SlidingTabStrip mTabStrip;
		...
		public MySoal_SlidingTabScrollView(Context context) : this(context, null) { }

		public MySoal_SlidingTabScrollView(Context context, IAttributeSet attrs) : this(context, attrs, 0) { }

		public MySoal_SlidingTabScrollView (Context context, IAttributeSet attrs, int defaultStyle) : base(context, attrs, defaultStyle)
		{
			...
			FillViewport = true;
			this.SetBackgroundColor(Android.Graphics.Color.ParseColor("#F44336")); //Gray color 248	159	21 0xE5, 0xE5, 0xE5

			mTitleOffset = (int)(TITLE_OFFSET_DIPS * Resources.DisplayMetrics.Density);

			mTabStrip = new MySoal_SlidingTabStrip(context);
		...
		private void PopulateTabStrip()
		{
			...
			for (int i = 0; i < adapter.Count; i++)
			{
				...
				tabView.Text = ((MySoal_ViewPagerAdapter)adapter).GetHeaderTitle(i);
